<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="homepage.aspx.cs" Inherits="Comp466_Assign3a.part4.homepage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Part 4 - Comware</title>
    ...
    <form id="homepageForm" runat="server">
        ...
        <asp:UpdatePanel style="margin-top: 150px" ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <a id="slideshowHyperlink" runat="server" href="buildComputer.aspx">
                    <asp:Image ID="slideshowImage" CssClass="slideshowImage" runat="server" ImageUrl="~/part4/assets/images/ads/ad1.png" /></a>
                <br />
                <br />
                <br />
        ...
        <div class="productCategoryIcons">
            <div class="productCategoryRow">
                <div class="productTypeContainer">
                    <a id="buildPC_icon" class="productTypeImage" href="buildComputer.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/buildComputer.png" /></a>
                    <p class="productTextDesc">Build Computer</p>
                </div>
                <div class="productTypeContainer">
                    <a id="gpu_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/graphicsCard.png" /></a>
                    <p class="productTextDesc">Graphics Card</p>
                </div>
                <div class="productTypeContainer">
                    <a id="cpu_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/cpu.png" /></a>
                    <p class="productTextDesc">CPU</p>
                </div>
                <div class="productTypeContainer">
                    <a id="monitor_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/monitor.png" /></a>
                    <p class="productTextDesc">Monitor</p>
                </div>
            </div>
            <div class="productCategoryRow">
                <div class="productTypeContainer">
                    <a id="os_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/operatingSystem.png" /></a>
                    <p class="productTextDesc">OS</p>
                </div>
                <div class="productTypeContainer">
                    <a id="ram_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/ram.png" /></a>
                    <p class="productTextDesc">RAM</p>
                </div>
                <div class="productTypeContainer">
                    <a id="soundcard_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/soundCard.png" /></a>
                    <p class="productTextDesc">Soundcard</p>
                </div>
                <div class="productTypeContainer">
                    <a id="hdd_icon" class="productTypeImage" href="orderParts.aspx" runat="server">
                        <img style="width: 75px; height: 75px" alt="Store Logo" src="assets/images/comware_icons/hdd.png" /></a>
