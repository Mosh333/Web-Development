<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buildComputer.aspx.cs" Inherits="Comp466_Assign3a.part4.buildComputer" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Part 4 - Build PC</title>
                ...
                <div class="buildDesktopContainer" style="margin-left: 230px">
                    ...
                    <div id="Fade1" runat="server" class="w3-container city w3-animate-opacity desktopArea" style="display: none">
                        ...
                        <div class="brandName">
                            ...
                            <asp:Image ID="brandnameImage" CssClass="buildImageStyle" runat="server" ImageUrl="~/part4/assets/images/brands/comware.png" />
                        ...
                        <div class="operatingSystem">
                            ...
                            <asp:Image ID="operatingSystemImage" CssClass="buildImageStyle" runat="server" ImageUrl="~/part4/assets/images/operatingSystem/windows10.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="monitorSize">
                            ...
                            <asp:Image ID="monitorImage" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/monitor/monitor_21inch.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        ...
                        <div class="cpuSelection">
                            ...
                            <asp:Image ID="cpuImage" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/cpu/intel_i3.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="gpuSelection">
                            ...
                            <asp:Image ID="gpuImage" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/gpu/gt1030.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="hddSelection">
                            ...
                            <asp:Image ID="hddImage" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/hdd/hdd500.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="ramSelection">
                            ...
                            <asp:Image ID="ramImage" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/ram/ram4gb.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="soundcardSelection">
                            ...
                            <asp:Image ID="soundcardImage" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/soundcard/soundcardRegular.png" />
                            <%--                    <br />
                    <br />--%>
                        </div>
                    ...
                    <div id="Fade2" runat="server" class="w3-container city w3-animate-opacity laptopArea" style="display: none">
                        ...
                        <div class="brandName">
                            ...
                            <asp:Image ID="brandnameImage_laptop" CssClass="buildImageStyle" runat="server" ImageUrl="~/part4/assets/images/brands/comware.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="operatingSystem">
                            ...
                            <asp:Image ID="operatingSystemImage_laptop" CssClass="buildImageStyle" runat="server" ImageUrl="~/part4/assets/images/operatingSystem/windows10.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="monitorSize">
                            ...
                            <asp:Image ID="monitorImage_laptop" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/monitor/laptop_13inch.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        ...
                        <div class="cpuSelection">
                            ...
                            <asp:Image ID="cpuImage_laptop" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/cpu/intel_i3.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="gpuSelection">
                            ...
                            <asp:Image ID="gpuImage_laptop" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/gpu/gt1030.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="hddSelection">
                            ...
                            <asp:Image ID="hddImage_laptop" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/hdd/hdd500.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="ramSelection">
                            ...
                            <asp:Image ID="ramImage_laptop" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/ram/ram4gb.png" />
                            <hr style="border-top: 2px solid black;" />
                        </div>
                        <div class="soundcardSelection">
                            ...
                            <asp:Image ID="soundcardImage_laptop" runat="server" CssClass="buildImageStyle" ImageUrl="~/part4/assets/images/soundcard/soundcardRegular.png" />
                            <%--                    <br />
                    <br />--%>
                        </div>
                        <hr style="border-top: 2px solid red;" />
