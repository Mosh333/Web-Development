<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aboutUs.aspx.cs" Inherits="Comp466_Assign3a.part3.aboutUs" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Part 3 - About Us</title>
...
<body>
    ...
    <form id="aboutUsForm" runat="server">
        ...
        <div id="aboutUsDescription">
            ...
            <p>Founded in 2019, Comware is a retailer of personal computers, and components.
            ...
            <p>With a strengthening customer base and ever-growing demand across students, 
                ...
                his basement/garage.</p>
            <p>The key to their success resides in a constant improvement of business practices,
                as well as a knowledgeable and passionate team of people who go beyond expectations
                while maintaining the trust and confidence of their customers.</p>
        </div>
